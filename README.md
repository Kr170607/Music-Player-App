...
You don’t need to enter your real password — you can create your own custom password inside the app.
You think that why this app require signup page , this  is for just to know that how many users using this app.
This app is compatible for android 10 or above this.
